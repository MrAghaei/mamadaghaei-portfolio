...
export const SkillBadge: React.FC<SkillBadgeProps> = ({
  ...
  return (
    <div
      className={`flex space-x-2 px-3 py-1.5 rounded-md text-sm font-medium shadow-sm transition-transform hover:scale-105 ${skill.backgroundColor} ${skill.textColor} ${className || ""}`}
      style={style}
